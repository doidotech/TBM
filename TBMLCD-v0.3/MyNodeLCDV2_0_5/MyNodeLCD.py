...
def display_price_text(currency):
    try:
        ...
        draw_centered_text(disp.buffer, sats_msg, get_inverted_x(113,sat_font_size), 270, sat_font, fill="#f7f7f7")
...
print('Running MyNode LCD script Version 1.0.9')

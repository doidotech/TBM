...
def draw_screen3():
    ...
    draw_left_justified_text(disp.buffer, size_text, get_inverted_x(size_value_x,size_value_font_size),61, 270, size_value_font, fill="#6303fc")

# Start the display of images now.
print('Running Raspiblitz LCD script Version 1.0.9')
#Display Raspiblitz logo first for 60 seconds
display_background_image('RaspiBlitz_Logo.png')
disp.display()
time.sleep(60)

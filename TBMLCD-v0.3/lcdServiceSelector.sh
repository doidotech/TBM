...
while $gettingUserChoice 
	do
		...
		then
		   ...
		   # Install lcd service
		   cd ..
		   sudo cp -r UmbrelLCDV1_0_9 /usr/bin
		   cd /usr/bin/UmbrelLCDV1_0_9
		...
		then
		   ...
		   gettingUserChoice=false
		   # Install lcd driver
		   cd RaspiBlitzLCDV1_0_6
		   sudo chmod +x lcdSetupScript.sh
		   sudo ./lcdSetupScript.sh
		   # Install lcd service
		   cd ..
		   sudo cp -r RaspiBlitzLCDV1_0_6 /usr/bin
		   cd /usr/bin/RaspiBlitzLCDV1_0_6
		...
		then
		   ...
		   # Install lcd service
		   cd ..
		   sudo cp -r MyNodeLCDV2_0_5 /usr/bin
		   cd /usr/bin/MyNodeLCDV2_0_5

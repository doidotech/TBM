#-------------------------------------------------------------------------------
#   DOIDO Technologies
#   RoninDojo LCD Python file
#   Version  : 1.0.0
#   Location : github
#-------------------------------------------------------------------------------

#-------------------------------------------------------------------------------
# This script displays five screens for the RoninDojo project:
#    1. First screen displays the RoninDojo logo.
#    2. Second screen has bitcoin price and the number of satoshis per unit of
#       the currency used.
...
#    6. First screen is displayed once for 60 seconds.
#    7. Second, third, fourth and fifth screens are displayed in a loop; second screen 
#       is displayed for 60 seconds, third, fourth and fifth screens for 30 seconds 
#       each.   
#-------------------------------------------------------------------------------
...
#userScreenChoices = "Screen1,Screen2,Screen3,Screen4"
...
def display_temperature():
    # Measure temperature
    temp_result = subprocess.run(['/opt/vc/bin/vcgencmd', 'measure_temp'], stdout=subprocess.PIPE)
...
print('Running RoninDojo LCD script Version 1.0.0')
#Display RoninDojo logo first for 60 seconds
display_background_image('ronindojo_logo.png')
disp.display()
time.sleep(60)
